<html>
    ...
    <body onload="limpiar();">
        <div id="contenedor">
            ...
            <a href="<?php echo Conectar::ruta() ?>/?accion=principal" title="Volver al principal"><img src="<?php echo Conectar::ruta() ?>/public/images/home.png" border="0"></a>Principal
            <a href="<?php echo Conectar::ruta() ?>/?accion=usuarios" title="Volver a lista usuarios"><img src="<?php echo Conectar::ruta() ?>/public/images/list.png" border="0"></a>usuarios
