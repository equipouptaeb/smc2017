<html>
    ...
    <body >
            ...
            <form action="" method="post" name="mod_obra" enctype="multipart/form-data">
                <table width="385" border="0" align="center" class="Estilo1">
                    <tr>
                        ...
                        <td width="207"><input name="nom_obra" type="text" size="50" maxlength="50" value="<?php echo $datos[0]["nom_obra"] ?>" ><span class="Estilo2">*</span></td>
                    </tr>
                    <tr>
        ...
        ?>
                    ...
                    <tr>
                        <td align="right" height="30">Nombre de la Colección:</td><td><input name="colec_obra" type="text" size="40" maxlength="40" value="<?php echo $datos[0]["colec_obra"] ?>"><span class="Estilo2">*</span></td>
                    </tr>
                    <tr>
                        <td align="right" height="30">Condición de la obra:</td><td><input name="cond_obra" type="text" size="40" maxlength="40" value="<?php echo $datos[0]["cond_obra"] ?>"><span class="Estilo2">*</span></td>
                    </tr>
                    <tr>
                        <td align="right" height="30">Imagen de la obra:</td><td>
                            <input  type="file" name="foto_obra" value="<?php echo $datos[0]["foto_obra"] ?>"><?php echo $datos[0]["foto_obra"] ?>
                            <img src="<?php echo Conectar::ruta() ?>/public/images/fotoObras/<?php echo $datos[0]["foto_obra"] ?>"  width="300" height="200">
                    </tr>
                    <tr>
