                    ...
                    ?>
                      ...
                      <form action="" method="post" enctype="multipart/form-data" name="ingreso_usuario">
                            <table width="385" border="0" align="center" class="Estilo1">
                                ...
                                <tr>
                                    <td align="right" height="30">Nombre:</td><td><input name="nom_usu" type="text" size="15" maxlength="15"><span class="Estilo2">*</span> </td>
                                </tr>
                                <tr>
                                    <td align="right" height="30">Apellido:</td><td><input name="ape_usu" type="text" size="15" maxlength="15"><span class="Estilo2">*</span></td>
                                </tr>
                                <tr>
