        ...
        <div id="contenedor" >
            ...
            <form action="" method="post" name="ingreso_dep">
                <table width="500" border="0" align="center" class="Estilo1">
                    ...
                    <tr>
                        <td align="right" height="30">Nombre:</td><td><input name="nom_dep" type="text" size="80" maxlength="80"><span class="Estilo2">*</span> </td>
                    </tr>
                    <tr>
                        <td align="right" height="30">dirección:</td><td><textarea name="dir_dep" rows="5" cols="50"></textarea><span class="Estilo2">*</span></td>
                    </tr>
                    <tr>
                        <td align="right" height="30">Teléfono:</td><td><input name="telf_dep" type="text" size="15" maxlength="15"><span class="Estilo2">*</span></td>
                    </tr>
                    <tr>
